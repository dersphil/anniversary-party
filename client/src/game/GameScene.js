...
export class GameScene extends Phaser.Scene {
    constructor() {
        ...
        Object.defineProperty(this, "socketManager", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "otherPlayers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        ...
        Object.defineProperty(this, "roomPanel", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "chatInput", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    setupNetworking() {
        this.socketManager.socket.on("roomJoined", (data) => {
            this.roomCode = data.roomCode;
            this.ready = true;
            this.player = new Player(this, data.player.x, data.player.y, this.playerName.toLowerCase() === "dhruv" ? "player-dhruv" : "player-maria");
            this.physics.add.collider(this.player, this.map.obstacles);
            Object.values(data.players).forEach((player) => {
                if (player.id !== this.socketManager.socket.id)
        ...
        this.socketManager.socket.on("roomError", (message) => this.updateRoomStatus(message));
        this.socketManager.socket.on("playerJoined", (player) => this.addOtherPlayer(player));
        this.socketManager.socket.on("playerMoved", (player) => {
        ...
        this.socketManager.socket.on("playerLeft", (id) => {
            this.otherPlayers.get(id)?.destroy();
            this.otherPlayers.delete(id);
            this.bubbles.get(id)?.destroy();
            this.bubbles.delete(id);
        });
        this.socketManager.socket.on("chatMessage", (data) => {
    ...
    showQuizQuestion(index) {
        ...
        const content = this.roomPanel.querySelector("#quiz-content");
    ...
    showQuizPopup(message, continueTo) {
        const popup = this.roomPanel.querySelector("#quiz-popup");
        popup.hidden = false;
    ...
    showRoomFields() {
        ...
        const name = content.querySelector("#player-name");
        const roomCode = content.querySelector("#room-code");

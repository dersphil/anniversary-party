...
export class RooftopMap {
    ...
    draw() {
        ...
        for (let x = 245; x <= 710; x += 58)
            graphics.lineBetween(x, 265, x, 485);
        for (let y = 265; y <= 485; y += 55)
            graphics.lineBetween(245, y, 710, y);
        ...
        this.addPlant(95, 275);
        this.addPlant(150, 535);
        this.addPlant(852, 550);
        this.addTable(105, 405);
        this.addTable(105, 500);
        this.addTable(825, 220);
